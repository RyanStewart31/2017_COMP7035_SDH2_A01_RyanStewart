...
public class MyDoubleDynamicQueue<T> implements MyQueue<T> {
	...
	public void removeByFirst(){
		...
		switch (scenario) {
			...
			case 2:
				...
				System.out.println("Error: Cannot remove first node. Reason: Queue is empty.");
				break;
	...
	public T last(){
		...
		switch (scenario) {
			...
			// Print error and return null
			default:
				System.out.println("Error: Cannot get last node. Reason: Queue is empty.");
				return null;
		}
	}
	...
	public void removeByLast(){
		...
		switch (scenario) {
			...
			case 2:
				...
				System.out.println("Error: Cannot remove last node. Reason: Queue is empty.");
				break;
